...
<body>
	...
	<main>
		<form action="addstudent" onsubmit="return validateForm()" method="post">
			...
			<span id="mobile-error" style="display: none;">Invalid mobile number</span>
			
			<label for="email">Email:</label>
			<input type="email" id="email" name="email" required>
		 n  <span id="email-error" style="display: none;">Invalid email address</span>
